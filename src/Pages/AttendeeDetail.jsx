  ...
  return (
    <div className="attendeeDetail">
      ...
      {errors.fullName}
        ...
        <label htmlFor="email"><p>Enter your email:</p></label>
        <input
          id="email"
          type="email"
          name="email"
        ...
        <label htmlFor="text-area"><p>Special request?</p></label>
        <input
          id="text-area"
          type="text"
          name="text-area"
        ...
        <div className="buttons">
            <button className="one" type="submit" tabIndex="0" onClick={() => navigate("/AttendeeDetail")}>
              Back
            </button>
